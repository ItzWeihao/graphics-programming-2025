...
void ParticlesApplication::Update()
{
    ...
    if (window.IsMouseButtonPressed(Window::MouseButton::Left))
    {
        ...
        float size = RandomRange(10.f, 30.f);
...
void ParticlesApplication::InitializeShaders()
{
    ...
    LoadAndCompileShader(vertexShader, "C:/GraphicsProgramming/graphics-programming-2025/exercises/exercise02/shaders/particles.vert");

    // Load and compile fragment shader
    Shader fragmentShader(Shader::FragmentShader);
    LoadAndCompileShader(fragmentShader, "C:/GraphicsProgramming/graphics-programming-2025/exercises/exercise02/shaders/particles.frag");
