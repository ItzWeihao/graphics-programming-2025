...
vec3 GetBlinnPhongReflection(vec3 objectColor, vec3 lightVector, vec3 normalVector, vec3 viewVector) 
{
...
void main()
{
	...
	FragColor = vec4(GetBlinnPhongReflection(objectColor.rgb, lightVector, normalVector, viewVector), 1.0f);
}
